...
parser.add_argument("--out", type=str, default="services/nlp_intent/out")
parser.add_argument("--csv", type=str, default="data/sample_intent.csv")
args = parser.parse_args()

labels = ["reminder_medication","appointment","mood","symptom_alert","smalltalk"]
...
trainer = Trainer(
    ...
    tokenizer=tokenizer,              # (deprec warning ok)
